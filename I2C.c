...
void I2C_GPIO_Init(void) {
	...
	// PB6 AF I2C1_SCL, PB7 AF I2C1_SDA
...
void I2C_Initialization(void){
	...
	// timing
	// set prescaler such that t_PRESC = 1us
	I2C1->TIMINGR &= ~I2C_TIMINGR_PRESC;
	I2C1->TIMINGR |= 79UL << I2C_TIMINGR_PRESC_POS;
	
	// minimum t_su = 1us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLDEL;
	I2C1->TIMINGR |= 1UL << I2C_TIMINGR_SCLDEL_POS;
	
	// minimum t_h = 1.25us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SDADEL;
	I2C1->TIMINGR |= 1UL << I2C_TIMINGR_SDADEL_POS;
	
	// minimum high period = 4us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLH;
	I2C1->TIMINGR |= 4UL << I2C_TIMINGR_SCLH_POS;
	
	// minimum low period = 4.7us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLL;
	I2C1->TIMINGR |= 4UL << I2C_TIMINGR_SCLL_POS;
